function ColorMyPencils(color)
    ...
    vim.api.nvim_set_hl(0, "TelescopeResultsTitle", { fg = "#eeeeee", bg = "#ff5454", bold = true })
    vim.api.nvim_set_hl(0, "TelescopePreviewTitle", { fg = "#eeeeee", bg = "#ff5454", bold = true })
    ...
    vim.api.nvim_set_hl(0, "TelescopePromptTitle", { fg = "#eeeeee", bg = "#ff5454", bold = true })
    vim.api.nvim_set_hl(0, "MsgArea", { fg = "#80a0ff", bg = "#323437", bold = true })
end
