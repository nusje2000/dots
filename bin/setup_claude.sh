...
mkdir -p "$HOME/.claude/cc_state"
link_file "$PROJECT_DIR/claude/cc_hook.sh"        "$HOME/.claude/cc_hook.sh"
link_file "$PROJECT_DIR/claude/cc_tmux_status.sh" "$HOME/.claude/cc_tmux_status.sh"
link_file "$PROJECT_DIR/claude/cc_picker.sh"      "$HOME/.claude/cc_picker.sh"
