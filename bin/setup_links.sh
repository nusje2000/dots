...
link_file "$PROJECT_ROOT/tmux/.tmux.conf" "$HOME/.tmux.conf"
link_file "$PROJECT_ROOT/alacritty" "$HOME/.config/alacritty"
link_file "$PROJECT_ROOT/phpactor" "$HOME/.config/phpactor"
